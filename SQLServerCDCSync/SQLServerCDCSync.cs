    ...
    class SQLServerCDCSync
    {
        public static void GenerateMergeLoadSSISPackage(string filename, string sourceconn, string destinationconn, string[] tables)
        {
            ...
            foreach (var table in tables)
            {
                ...
                cdcControlTaskGetRange.Name = "Get CDC Processing Range for " + table;
                ...
                cdcControlTaskGetRange.Properties["StateVariable"].SetValue(cdcControlTaskGetRange, "User::CDC_State_" + table);
                cdcControlTaskGetRange.Properties["AutomaticStatePersistence"].SetValue(cdcControlTaskGetRange, true);
                cdcControlTaskGetRange.Properties["StateName"].SetValue(cdcControlTaskGetRange, "CDC_State_" + table);
                ...
                parameterBinding.DtsVariableName = "CDC_State_" + table;
                ...
                cdcControlTaskMarkRange.Name = "Mark CDC Processed Range for " + table;
                cdcControlTaskMarkRange.Properties["Connection"].SetValue(cdcControlTaskMarkRange, sourceManager.ID);
                cdcControlTaskMarkRange.Properties["TaskOperation"].SetValue(cdcControlTaskMarkRange, CdcControlTaskOperation.MarkInitialLoadEnd);
                cdcControlTaskMarkRange.Properties["StateConnection"].SetValue(cdcControlTaskMarkRange, destinationManager.ID);
                cdcControlTaskMarkRange.Properties["StateVariable"].SetValue(cdcControlTaskMarkRange, "User::CDC_State_" + table);
                cdcControlTaskMarkRange.Properties["AutomaticStatePersistence"].SetValue(cdcControlTaskMarkRange, true);
                cdcControlTaskMarkRange.Properties["StateName"].SetValue(cdcControlTaskMarkRange, "CDC_State_" + table);
